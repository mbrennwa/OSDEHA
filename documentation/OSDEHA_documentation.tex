...
The input stage amplify the balanced input with the voltage gain to drive the output stage as shown in \figr{801A_curves}. 

With a balanced line-level peak-to-peak input of $2 x \SI{3.5}{V}$ and a balanced peak-to-peak drive of $2 x \SI{86}{V}$ for the ouput stage (\figr{801A_curves}), a voltage gain of $86 / 3.5 = 25\times$ is needed. Screening the available data on the gain and linearity\cite{bartola_thdbenchmark,millett_pentodes,klausmobile_testerfiles} of several low-power tubes, E180F or 6E5P tubes used as triodes appear to be suitable choices for the input stage.
