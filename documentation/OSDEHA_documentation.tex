...
\begin{itemize}
\item Assemble the power-supply chassis and boards. Install the boards, sockets, and transformers in the power-supply chassis. Connect the primary windings of the transformers to the mains inlet and power switch in the chassis. Connect the power supply outputs to the umbilical sockets.
