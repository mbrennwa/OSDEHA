...
\begin{itemize}
\item Determine the CCS sense-resistor values that yield the targeted bias currents using a test jig for the specific DN2540 depletion-mode FETs (input LTP tail, drivers for the DHT grids).
