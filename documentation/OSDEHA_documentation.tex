...
% 1. Build and test power supply
% - Make sure there are no shorts to the chassis, all transistors are properly insulated to the chassis/heatsinks.
% - Connect transformer primaries to mains via variac.
% - Connect transformer secondaries of heater supply and bring up slowly with variac. Confirm heater supply voltage and function of HV delay relay.
